...
### Prerequisites
Microsoft Visual Studio 2019 (preferably the latest version), platform toolset v142 >, DirectX Development Kit (Optional?) and Windows SDK 10.0.x.x are required in order to compile it.
